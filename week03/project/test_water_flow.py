...
def test_pressure_loss_from_pipe():
    assert pressure_loss_from_pipe(0.048692, 0.00, 0.018, 1.75) == approx(0, abs=0.001)
    assert pressure_loss_from_pipe(0.048692, 200.00, 0.000, 1.75) == approx(0, abs=0.001)
...
def test_convert_kpa_to_psi():
    ...
    assert convert_kpa_to_psi(100) == approx(14.5038, abs=0.01)
    assert convert_kpa_to_psi(200) == approx(29.0076, abs=0.01)
    assert convert_kpa_to_psi(295.628) == approx(42.879, abs=0.01)
